...
<div>
    <div class="row">
        ...
        <div class="col-sm-8" id="cuadroTexto">
            <h3>
                ...
                <span class="colorLetraRojo">forma presente lógicamente en presente</span> o después de un auxiliar y siempre tenga en cuenta que los auxiliares sirven para negar o preguntar.
            </h3>
        </div>
        <div class="col-sm-2"></div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-9">
            <tablaTC class="overflow-auto" :cuestionario="$data.cuestionario1P27" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-7">
            <tablaTC class="overflow-auto" :cuestionario="cuestionario2P27" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-8" id="cuadroTexto">
            <h3>
                ...
                <span class="colorLetraRojo">presente, pasado, participio y progresivo.</span>
                existen
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <tablaTC class="overflow-auto" :cuestionario="$data.cuestionario2P28" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row" style="margin:0em;">
        ...
        <div class="col-sm-10 row">
            <div class="col-sm-1" v-for="(item, index) in palabrasListaP28.fields" style="margin:0; padding:0;">
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-9">
            <tablaTC class="overflow-auto" :cuestionario="tabla1P29" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-9">
            <tablaTC class="overflow-auto" :cuestionario="tabla2P29" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6" id="text">
            <opcionMultiple :options="$data.cuestionarioP30" :rEsperadas="$data.respuestasCuestionarioP30" @respuestas="$data.mensajeRespuestasP30 = $event" />
        </div>
        <b-modal ref="my-modalP30" hide-footer title="RESULTADO">{{mensajeRespuestasP30}}</b-modal>
        <div class="col-sm-1"></div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-3">
            <b-button variant="primary" @click="showModal('my-modalP30')">VERIFICAR PREGUNTAS</b-button>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-sm-6" style="text-align:left;">
            <legend id="5__BV_label_" tabindex="-1" class="bv-no-focus-ring col-form-label pt-0 col-form-label-lg labelPregunta">7. Ubique la forma del verbo “ir” en inglés en las siguientes oraciones:</legend>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-9">
            <tablaTC class="overflow-auto" :cuestionario="tabla3P29" :inglesR="false" :espanolR="false" />
        </div>
        <div class="col-sm-1"></div>
    </div>
    ...
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-6" style="text-align:left;">
            <legend id="5__BV_label_" tabindex="-1" class="bv-no-focus-ring col-form-label pt-0 col-form-label-lg labelPregunta">8. Ubique al frente de la traducción en español el verbo con poder en inglés.</legend>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-6">
            <tablaTC class="overflow-auto" :cuestionario="tabla1P31" :inglesR="false" :espanolR="false" />
        </div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-6" style="text-align:left;">
            <legend id="5__BV_label_" tabindex="-1" class="bv-no-focus-ring col-form-label pt-0 col-form-label-lg labelPregunta">9. Traduce las siguientes oraciones al inglés.</legend>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <tablaTC class="overflow-auto" :cuestionario="tabla2P31" :inglesR="false" :espanolR="false" />
        </div>
    </div>
    <div class="row">
        <div class="col-sm-1"></div>
        <div class="col-sm-10">
            <tablaTC class="overflow-auto" :cuestionario="tabla3P31" :inglesR="false" :espanolR="false" />
        </div>
    </div>
    <div class="row">
        <div class="col-sm-2"></div>
